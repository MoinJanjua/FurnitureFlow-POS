...
class SettingsViewController: UIViewController ,UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        settingList = ["Home","About Us","Clear All","Feedback","Share App","Privacy Notice"]
    ...
    private func NavToWelcome() {
        ...
        private func clearUserData() {
            ...
            UserDefaults.standard.removeObject(forKey: "ProductDetails")
            NavToWelcome()
...
extension SettingsViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.item == 0 {
            ...
            let appID = "FurnitureFlowPOS" // Replace with your actual App ID
